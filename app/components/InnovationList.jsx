...
export default function InnovationList({ inovasiList, onSelectInovasi, initialId }) {
  ...
  return (
    <div className="w-full h-full min-h-[calc(100vh-72px)] flex items-center justify-center relative bg-[#021526] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-10 lg:px-24 py-8 flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-16">
         ...
         <div className="flex-1 w-full flex flex-col justify-center animate-fadeInLeft">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4 h-[26px] overflow-hidden">
               <span className="bg-white text-[#0B5E90] text-[10px] font-extrabold uppercase tracking-widest px-3 py-1.5 rounded shadow-sm whitespace-nowrap">
                 {currentItem.pilar || 'PILAR UMUM'}
               </span>
               <span className="bg-white text-[#F26522] text-[10px] font-extrabold uppercase tracking-widest px-3 py-1.5 rounded shadow-sm whitespace-nowrap">
                 {currentItem.nilai_berakhlak || 'KATEGORI'}
               </span>
            </div>

            <div className="min-h-[150px] sm:min-h-[160px] lg:min-h-[180px] flex flex-col justify-start">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-4 leading-tight drop-shadow-md line-clamp-2">
         ...
         <div className="w-full lg:w-[50%] flex justify-center lg:justify-end animate-fadeInRight">
            <div className="relative w-full max-w-[560px] aspect-[4/3] sm:aspect-[16/10] bg-slate-900/50 rounded-[20px] p-2 shadow-2xl border border-white/10 group backdrop-blur-sm">
               <div className="relative w-full h-full rounded-[14px] overflow-hidden bg-slate-800 shadow-inner">
                 ...
                 <div className="absolute bottom-4 left-0 w-full flex justify-center gap-2 z-30 px-4">
