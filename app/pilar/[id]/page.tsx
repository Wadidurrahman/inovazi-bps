  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (pilarData) setPilarName(pilarData.nama_pilar);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">
            Inovasi Berdasarkan: <span className="text-orange-500">{pilarName}</span>
          </h1>
          <p className="mt-2 text-slate-600">Daftar program dan inovasi yang bernaung di bawah pilar ini.</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-200 border-dashed p-12 text-center">
            ...
            <p className="text-slate-500 max-w-sm mx-auto">
              Saat ini belum ada data inovasi yang didaftarkan pada pilar ini.
            </p>
          </div>
        )}
